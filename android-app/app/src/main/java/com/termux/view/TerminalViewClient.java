...
public interface TerminalViewClient {
    ...
    /**
     * Called when Ctrl/Alt key state from {@link #readControlKey()}/{@link #readAltKey()}
     * has been consumed by one input event. Client should reset the modifier state
     * (one-shot semantics: press Ctrl, type one char, modifier turns off automatically).
     */
    default void onModifierKeysConsumed() {}
